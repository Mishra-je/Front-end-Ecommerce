...
const Footer = () => {
  return (
      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">Mishra_jee</tspan>
                    </text>
                  </g>
                </g>
              </svg>
            ...
            E-commerce websites can range from large marketplaces like Amazon to niche stores focusing on specific products or services. They play a crucial role in the modern retail landscape, offering convenience and a wider reach for businesses.
            </p>
          </div>

          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-red-800">Company</h2>
            </div>
            <ul class="leading-8">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-red-800">Blog</h2>
            </div>
            <ul class="leading-8">
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-red-800">Connect With Us</h2>
            </div>
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-red-600 hover:border-blue-400">
            ...
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-red-600 hover:border-blue-400">
    ...
    <div class="bg-red-700 py-4 text-gray-100">
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2024
            <script>new Date().getFullYear()  2024 && document.write("- " + new Date().getFullYear())</script>- 2025
            Mishra_jee. All Rights Reserved.
          </div>
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with  by Sachin
          </div>
